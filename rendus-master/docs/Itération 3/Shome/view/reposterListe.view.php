...
<head>
  <title>Shome - Reposter une liste</title>
...
<body>
  ...
  <div>
    <div id="titre">
      ...
      <h1>Reposter une liste</h1>
    </div>
  </div>

  <form action="../controler/gestionListes.ctrl.php?action=posterListe&idListe=<?=$liste->getIdList()?>" method="post">
    <div id="listeProduit">
    ...
    <input type="submit" value="Reposter cette liste de course" id="boutonPoster">
  </form>
