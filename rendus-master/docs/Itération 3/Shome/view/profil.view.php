  ...
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="profil ">
        ...
        <form action="../controler/supprimerCompte.ctrl.php" onsubmit="return confirm('Etes vous sûr de vouloir supprimer votre compte ? Cette action effacera toutes vos informations de notre base de données et sera irréversible.');">
