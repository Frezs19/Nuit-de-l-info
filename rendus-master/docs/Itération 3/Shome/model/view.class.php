...
class View {
  ...
  function display(string $filename) {
    ...
    // Tous les paramètre de $this-param sont dupliqués en des variables
    ...
    foreach ($this->param as $key => $value) {
      // La notation $$ désigne une variable de le nom est dans une autre variable
      // Cela crée une variable locale dont le nom est dans $key
      $$key = $value;
    }
